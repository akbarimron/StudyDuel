              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: IconHandler.buildItemIcon(avatar, size: 60, color: AppColors.primary),
                    ),
                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      FutureBuilder<int>(
                        future: FirebaseService().getUserLeaderboardRank(targetUid),
                        builder: (context, snapshot) {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                              stream: FirebaseService().getUserInventory(targetUid),
